...
class TextFile(BaseFile):
    """
    TextFile inherits the BaseFile class. This class
    allows the user to to add text
    ...
    The class also contains all the functions needed
    to read/write to a text file.
    """
    ...
    def clean_lines_of_whitespace(self):
        """
        Grabs the text file lines from the file as a list,
        removes extra whitespace, and then writes the list
        back to the file.
        """
