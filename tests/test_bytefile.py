...
@mark.parametrize(
    "file_path, contents_of_file, is_file",
    [
...
def test_basefile_append_byte_line_to_file(
    env_setup_for_file_object, file_path, contents_of_file, is_file  # noqa: E501, F811
):
    my_file = None
    try:
