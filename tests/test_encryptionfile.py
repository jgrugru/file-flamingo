...
def test_encryptor_encrypt_and_decrypt_data(encryptor,  # noqa: F811
                                            str_to_encrypt,
                                            exception_raised):
...
def test_encryptor_decrypt_and_decrypt_data(encryptor,  # noqa: F811
                                            original_str,
                                            is_decryptable):
    if is_decryptable:
...
def test_encryptionfile_encrypt_decrypt_file(tmp_path,
    ...
    txt_file = create_file(
        ...
        txt=str_to_encrypt)
    encryption_file = create_file(   # noqa: F811
        EncryptionFile,
        txt_file,
        rsa_file)
...
def test_encryptionfile_write_and_get_bytes(encryption_file,  # noqa: F811
                                            random_bytes,
                                            exception_raised):
...
def test_encryptionfile_accepts_file_object_as_arguments(base_file, rsa_file):  # noqa: E501, F811
    try:
